...
export const Phenomena = [
  ...
  "A sandstorm rages constantly and buries the area in sand.",
  ...
  "Indoor areas are now outdoors. Outdoor areas are indoors.",
  "The sun’s intensity is doubled or tripled.",
  ...
  "The area flickers like a software glitch.",
...
export const Scars = [
  ...
  "Paranoia - You think the world is out to get you, and you are right. Ordinary people are compelled to attack or rob you, police will harass you, etc.",
